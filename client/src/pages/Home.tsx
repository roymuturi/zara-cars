      ...
      <div className="original-hero-inner">
        <div className="original-hero-copy">
          ...
          <p>Browse clear prices, specifications, and next steps with Zara Cars. Every unit is verified, duty-paid, and ready for a showroom walk-through.</p>
           <div className="hero-actions"><Link href="/inventory" className="button button-red">Browse available stock <ArrowRight size={20} /></Link><Link href="/trade-in" className="button original-hero-link">Sell or trade in <ArrowRight size={20} /></Link></div>
           <div className="original-proof"><span><BadgeCheck size={16} /> Verified paperwork</span><span><Tag size={16} /> No surprise fees</span></div>
        </div>

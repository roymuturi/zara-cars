...
export const imageSet = {
  brandMark: "/Logo.jpg",
  harrierHero: "/images/harrier-hero.jpg",
  harrierFront: "/images/harrier-front.webp",
  harrierAngle: "/images/harrier-angle.jpg",
  harrierRear: "/images/harrier-rear.webp",
  harrierCabin: "/images/harrier-cabin.jpg",
  harrierDashboard: "/images/harrier-dashboard.jpg",
  harrierSeats: "/images/harrier-seats.jpg",
  rav4Front: "/images/rav4-front.jpg",
  foresterFront: "/images/forester-front.webp",
  foresterAngle: "/images/forester-angle.jpg",
  foresterCabin: "/images/forester-cabin.jpg",
  foresterInterior: "/images/forester-interior.jpg",
  cx5Front: "/images/cx5-front.png",
  cx5Angle: "/images/cx5-side.png",
  xtrailFront: "/images/xtrail-front.jpg",
  xtrailRear: "/images/xtrail-rear.jpg",
  hiluxFront: "/images/hilux-front.jpg",
  hiluxRear: "/images/hilux-rear.webp",
  dmax: "/images/dmax.webp",
  landCruiser: "/images/land-cruiser.jpeg",
  tiguanFront: "/images/tiguan-front.jpg",
  tiguanAngle: "/images/tiguan-angle.jpg",
  tiguanRear: "/images/tiguan-rear.jpg",
  tiguanSide: "/images/tiguan-side.jpg",
  showroom: "/images/showroom.jpg",
  localContext: "/images/showroom.jpg",
  automarkContext: "/images/showroom.jpg",
  localContextAlt: "/images/cx5-front.png",
};

export const makeMeta: Record<string, { short: string; color: string; light: string }> = {
  ...
  Isuzu: { short: "ISU", color: "#d04f27", light: "#fff0e9" },
  ...
  Mercedes: { short: "MB", color: "#25334d", light: "#eef1f6" },
  ...
  "Land Rover": { short: "LR", color: "#376b4d", light: "#eaf5ed" },
